...
local GameList = game:HttpGet('https://raw.githubusercontent.com/Xarkkz/loldumb/main/GameList.json')
function GetGame()
...
if Game then
    Supported = true
    Script = game:HttpGet('https://raw.githubusercontent.com/Xarkkz/loldumb/tree/main/Scripts/' .. Game.ScriptName)
end
...
LoadScript.BackgroundColor3 = Color3.fromRGB(124, 0, 255)
...
DuckLogo.Image = "rbxassetid://6336408581"
